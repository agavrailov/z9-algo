...
//#define ASSETLIST	"AssetsTestMT5"
//#define ASSET	"DAX-FUTX-20201218-FDAX-DTB-EUR"
//#define ASSET	"ES-FUTX-20181221-ES-GLOBEX-USD"
//#define ASSET	"IUSQ-STK-SMART-EUR"
//#define ASSET	"VIX-IND-CBOE-USD"
//#define ASSET	"EUR.ZAR"
...
#ifdef ASSETLIST
	printf("\nAsset list %s",ASSETLIST);
	assetList(ASSETLIST);
#endif
#ifdef ASSET
	ignore(53); // in case live prices are unavailable
	assetAdd(ASSET);
