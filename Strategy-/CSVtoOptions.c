...
// Example format: underlying symbol, exchange, date MMDDYYYY, adj close, option symbol, expiry MMDDYYYY, strike, Call/Put, American/European, ask, bid, volume, open interest, unadj close
// Sample: "TLT,NYSEArca,04/10/2015,129.62,TLT   150410C00112500,04/10/2015,112.5,C,A,17.3,16.2,0,0,129.62"

int Year = 2015;
string Ticker = "TLT"; // File name: TLT_2015.csv
string Format = ",,%m/%d/%Y,,,i,f,s,s,f,f,f,f,f"; // above sample format, with 1 header line
